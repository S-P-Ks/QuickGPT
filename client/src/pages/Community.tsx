...
import { dummyPublishedImages, type PublishedImage } from "../assets/assets";
          ...
          {images.map((item, idx) => {
            return (
              ...
              >
                <img
                  src={item.imageUrl}
                  className="w-full h-40 mg:h-50 2xl:h-62 object-cover group-hover:scale-105 transition-transform duration-300 ease-in-out"
                  alt=""
                />
